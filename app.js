...
let update = function (modifier) {
    ...
    //These if statements check that the ghost  stops at the hedges of the game so that it does not go out o bounds based on the x and y position.     

    //after they move we check: 
